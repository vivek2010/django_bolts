...
from django_bolts.dinja import builtins
...
JINJA2_GLOBALS.update({
    ...
    'widget_class':builtins.global_context.widget_class,
    'widget_class':builtins.global_context.field_class,     
    'widget':builtins.global_context.widget_render,
    'form_slice':builtins.global_context.form_slice,  
})
...
class Environment(Environment):
    def __init__(self, *args, **kwargs):
        ...
        from jinja2.ext import LoopControlExtension, WithExtension
...
#            self.globals.update(reg_attr.globals)
        ...
        self.add_extension(builtins.extensions.URLExtension)
#        self.add_extension(builtins.extensions.HTMLCompress)
#        self.add_extension(builtins.extensions.SelectiveHTMLCompress)
        self.add_extension(LoopControlExtension)
        self.add_extension(WithExtension)
...
initial_params = {
    ...
    'finalize': lambda a : u'' if a == None else a
}
...
default_mimetype = getattr(settings, 'DEFAULT_CONTENT_TYPE','text/html')
